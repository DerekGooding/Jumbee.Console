...
* Full mouse support via SGR 1006.
...
* Large set of common GUI controld: menus, buttons, trees, text inputs with autocomplete, modal dialog windows, etc....    
